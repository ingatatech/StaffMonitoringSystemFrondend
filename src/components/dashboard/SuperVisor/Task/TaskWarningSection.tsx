...
import { AlertTriangle, Filter, Search, Users, Calendar, CheckSquare } from "lucide-react"
import { Badge } from "../../../ui/Badge"

interface TaskWarningSectionProps {
...
const TaskWarningSection: React.FC<TaskWarningSectionProps> = ({
  hasActiveFilters,
  totalTaskCount,
  filterSummary,
  onClearFilters,
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3 flex-1">
            ...
            <div className="mt-2 text-sm text-amber-700">
              <p className="mb-3">
                To review tasks effectively, please apply filters to narrow down the task list. This will help you focus
                on specific tasks that need your attention.
              </p>
  ...
  // Don't show anything when tasks are found - let the task list handle the display
  return null
}

export default TaskWarningSection
