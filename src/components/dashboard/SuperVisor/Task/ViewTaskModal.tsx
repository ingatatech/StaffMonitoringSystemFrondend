          ...
          return (
            ...
            >
              ...
              <div className="flex space-x-2 opacity-70 group-hover:opacity-100 transition-opacity duration-200">
                <TooltipProvider className="bg-red">
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <a
                        href={doc.url || doc.secure_url}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-slate-100 hover:bg-slate-200 active:bg-slate-300 p-2.5 rounded-lg transition-all duration-200 hover:shadow-md hover:scale-105 active:scale-95"
                      >
                        <FaEye className="text-slate-600 h-3.5 w-3.5" />
                      </a>
                    </TooltipTrigger>
                    <TooltipContent>
                      <p>Preview file</p>
