...
import { RefreshCw, TrendingUp, Building } from "lucide-react"
...
const AdminDashboardHeader = ({ 
  ...
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden mb-6"
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 p-6 relative z-10">
        <div className="flex items-center space-x-4">
          ...
          >
            <Building className="h-8 w-8 text-gray-600 dark:text-gray-300" />
          </motion.div>
          ...
          <div>
            <motion.h1
              ...
              className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-1"
            >
            ...
            >
              ...
              Organization Status: <span className="font-semibold ml-1">{organizationStatus}</span>
            </motion.p>
          </div>
        </div>
