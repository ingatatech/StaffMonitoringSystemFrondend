...
import SystemLeaderDashboardNavbar from "./SystemLeaderDashboardNavbar";
import SystemLeaderDashboardSideBar from "./SystemLeaderDashboardSideBar";
import { useDispatch } from "react-redux";
import { logout } from "../../../Redux/Slices/LoginSlices";
import axios from "axios";
function SystemLeaderDashboardLayout() {
...
const dispatch = useDispatch();
  ...
  return (
        ...
        <div className="fixed top-0 left-0 right-0 z-50">
          <SystemLeaderDashboardNavbar toggleSidebar={toggleSidebar} />
        </div>
        ...
        <div className="flex flex-1 pt-16 h-full">
          ...
          <div className={`fixed inset-y-0 left-0 z-40 pt-16 h-full lg:translate-x-0 transition-transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
            ...
            <SystemLeaderDashboardSideBar isOpen={sidebarOpen} closeSidebar={() => setSidebarOpen(false)} />
          </div>
...
export default SystemLeaderDashboardLayout;